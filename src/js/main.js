...
form.addEventListener('submit',function(e){
  ...
  const button_center_div = document.createElement('div');
  button_center_div.setAttribute('class','button-center-div');
  ...
  button_center_div.append(button_up,button_down);
  button_div.append(button_center_div);
